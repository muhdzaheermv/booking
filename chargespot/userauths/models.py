...
class Profile(models.Model):
    pid = ShortUUIDField(length=7,max_length=25,alphabet="abcdefghijklmnopqurxyz1234567890")
    ...
    identity_type=models.CharField(max_length=200,choices=IDENTITIY_TYPE,null=True,blank=True)
